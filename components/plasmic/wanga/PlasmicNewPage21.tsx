...
import * as sty from "./PlasmicNewPage21.module.css"; // plasmic-import: 207rOv8ttS/css
...
export interface DefaultNewPage21Props {
  dataFetches: PlasmicNewPage21__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499048"}</title>
        <meta key="og:title" property="og:title" content={"499048"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_4991871Page001Jpg2.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
