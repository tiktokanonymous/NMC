...
import * as sty from "./PlasmicNewPage511.module.css"; // plasmic-import: pdM-KJnHNB/css
...
export interface DefaultNewPage511Props {
  dataFetches: PlasmicNewPage511__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499932"}</title>
        <meta key="og:title" property="og:title" content={"499932"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499932Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
