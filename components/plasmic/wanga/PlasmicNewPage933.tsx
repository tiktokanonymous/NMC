...
import sty from "./PlasmicNewPage933.module.css"; // plasmic-import: iqdcPjXCh-/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage933.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage933.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
