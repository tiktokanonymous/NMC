...
import * as sty from "./PlasmicNewPage312.module.css"; // plasmic-import: HbG3zzkX7C/css
...
export interface DefaultNewPage312Props {
  dataFetches: PlasmicNewPage312__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"500123"}</title>
        <meta key="og:title" property="og:title" content={"500123"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_500123Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
