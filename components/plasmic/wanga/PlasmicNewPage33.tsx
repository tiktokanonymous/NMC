...
import * as sty from "./PlasmicNewPage33.module.css"; // plasmic-import: xQHXwInJh-/css
...
export interface DefaultNewPage33Props {
  dataFetches: PlasmicNewPage33__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499136"}</title>
        <meta key="og:title" property="og:title" content={"499136"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499136Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
