...
import * as sty from "./PlasmicNewPage219.module.css"; // plasmic-import: gIi2pyDqOj/css
...
export interface DefaultNewPage219Props {
  dataFetches: PlasmicNewPage219__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499616"}</title>
        <meta key="og:title" property="og:title" content={"499616"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499616Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
