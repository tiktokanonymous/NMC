...
import * as sty from "./PlasmicNewPage98.module.css"; // plasmic-import: re9_-4oB5J/css
...
export interface DefaultNewPage98Props {
  dataFetches: PlasmicNewPage98__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499142"}</title>
        <meta key="og:title" property="og:title" content={"499142"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_4991421Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
