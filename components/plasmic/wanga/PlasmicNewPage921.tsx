...
import * as sty from "./PlasmicNewPage921.module.css"; // plasmic-import: mysfqJPTRC/css
...
export interface DefaultNewPage921Props {
  dataFetches: PlasmicNewPage921__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499686"}</title>
        <meta key="og:title" property="og:title" content={"499686"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499686Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
