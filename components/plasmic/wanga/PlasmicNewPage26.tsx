...
import sty from "./PlasmicNewPage26.module.css"; // plasmic-import: rtfxR5qmGE/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"600914"}</title>
        <meta key="og:title" property="og:title" content={"600914"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_600914Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
