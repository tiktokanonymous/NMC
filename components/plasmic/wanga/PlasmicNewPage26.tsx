...
export interface DefaultNewPage26Props {
  dataFetches: PlasmicNewPage26__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499091"}</title>
        <meta key="og:title" property="og:title" content={"499091"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499091Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
