...
import sty from "./PlasmicNewPage9.module.css"; // plasmic-import: 4dWwUF2vRV/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage9.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage9.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
