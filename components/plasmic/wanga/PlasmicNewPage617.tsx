...
import * as sty from "./PlasmicNewPage617.module.css"; // plasmic-import: P2Olb9Xi31/css
...
export interface DefaultNewPage617Props {
  dataFetches: PlasmicNewPage617__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499920"}</title>
        <meta key="og:title" property="og:title" content={"499920"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499920Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
