...
import * as sty from "./PlasmicNewPage104.module.css"; // plasmic-import: wg7n7fro1v/css
...
export interface DefaultNewPage104Props {
  dataFetches: PlasmicNewPage104__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"500141"}</title>
        <meta key="og:title" property="og:title" content={"500141"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_5001411Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
