...
import * as sty from "./PlasmicNewPage930.module.css"; // plasmic-import: EMBfo6a3M5/css
...
export interface DefaultNewPage930Props {
  dataFetches: PlasmicNewPage930__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499956"}</title>
        <meta key="og:title" property="og:title" content={"499956"} />
      </Head>
