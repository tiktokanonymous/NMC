...
import * as sty from "./PlasmicNewPage211.module.css"; // plasmic-import: ofkR4IeG2r/css
...
export interface DefaultNewPage211Props {
  dataFetches: PlasmicNewPage211__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499079"}</title>
        <meta key="og:title" property="og:title" content={"499079"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_4990791Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
