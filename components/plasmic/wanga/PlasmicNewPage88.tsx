...
import sty from "./PlasmicNewPage88.module.css"; // plasmic-import: kaZfMnfVu0/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage88.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage88.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
