...
import sty from "./PlasmicNewPage826.module.css"; // plasmic-import: uD93uME1Z-/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage826.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage826.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
