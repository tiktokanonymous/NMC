...
import * as sty from "./PlasmicNewPage82.module.css"; // plasmic-import: M8YHm3EiP2/css
...
export interface DefaultNewPage82Props {
  dataFetches: PlasmicNewPage82__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"498693"}</title>
        <meta key="og:title" property="og:title" content={"498693"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_4986931Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
