...
import * as sty from "./PlasmicNewPage925.module.css"; // plasmic-import: BUA920nIeA/css
...
export interface DefaultNewPage925Props {
  dataFetches: PlasmicNewPage925__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499902"}</title>
        <meta key="og:title" property="og:title" content={"499902"} />
      </Head>
