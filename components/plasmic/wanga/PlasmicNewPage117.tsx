...
export interface DefaultNewPage117Props {
  dataFetches: PlasmicNewPage117__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"498982"}</title>
        <meta key="og:title" property="og:title" content={"498982"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_498982Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
