...
import sty from "./PlasmicNewPage117.module.css"; // plasmic-import: urZpqrtdAk/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage117.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage117.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
