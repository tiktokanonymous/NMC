...
import * as sty from "./PlasmicNewPage937.module.css"; // plasmic-import: 69ZuPIDQcN/css
...
export interface DefaultNewPage937Props {
  dataFetches: PlasmicNewPage937__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499976"}</title>
        <meta key="og:title" property="og:title" content={"499976"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499976Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
