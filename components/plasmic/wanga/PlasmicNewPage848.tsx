...
import * as sty from "./PlasmicNewPage848.module.css"; // plasmic-import: ers2kMlXzG/css
...
export interface DefaultNewPage848Props {
  dataFetches: PlasmicNewPage848__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499419"}</title>
        <meta key="og:title" property="og:title" content={"499419"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_4994192Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
