...
import sty from "./PlasmicNewPage103.module.css"; // plasmic-import: 4BWOORsRbq/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage103.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage103.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_500420Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
