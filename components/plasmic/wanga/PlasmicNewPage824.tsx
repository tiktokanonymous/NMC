...
import * as sty from "./PlasmicNewPage824.module.css"; // plasmic-import: XxhD5GyG8u/css
...
export interface DefaultNewPage824Props {
  dataFetches: PlasmicNewPage824__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499112"}</title>
        <meta key="og:title" property="og:title" content={"499112"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499112Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
