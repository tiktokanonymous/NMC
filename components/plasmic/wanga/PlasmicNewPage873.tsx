...
import * as sty from "./PlasmicNewPage873.module.css"; // plasmic-import: ARZaukinp5/css
...
export interface DefaultNewPage873Props {
  dataFetches: PlasmicNewPage873__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499961"}</title>
        <meta key="og:title" property="og:title" content={"499961"} />
      </Head>
