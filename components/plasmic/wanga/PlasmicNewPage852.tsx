...
import sty from "./PlasmicNewPage852.module.css"; // plasmic-import: 1fOXf0p1Pk/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage852.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage852.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
