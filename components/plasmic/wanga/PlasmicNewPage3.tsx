...
import sty from "./PlasmicNewPage3.module.css"; // plasmic-import: 1kr4Mpr3_m/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage3.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage3.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_4991681Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
