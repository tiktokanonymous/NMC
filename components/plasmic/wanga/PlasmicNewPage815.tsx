...
import * as sty from "./PlasmicNewPage815.module.css"; // plasmic-import: WCrWfzeCx-/css
...
export interface DefaultNewPage815Props {
  dataFetches: PlasmicNewPage815__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499193"}</title>
        <meta key="og:title" property="og:title" content={"499193"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_4991931Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
