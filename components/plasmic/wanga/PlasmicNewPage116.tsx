...
import * as sty from "./PlasmicNewPage116.module.css"; // plasmic-import: i9sDrRn4Y6/css
...
export interface DefaultNewPage116Props {
  dataFetches: PlasmicNewPage116__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"498964"}</title>
        <meta key="og:title" property="og:title" content={"498964"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_498964Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
