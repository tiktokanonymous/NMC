...
import sty from "./PlasmicNewPage5.module.css"; // plasmic-import: xREbm6WKb9/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage5.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage5.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_600916Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
