...
export interface DefaultNewPage13Props {
  dataFetches: PlasmicNewPage13__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499041"}</title>
        <meta key="og:title" property="og:title" content={"499041"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499041Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
