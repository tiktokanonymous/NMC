...
import sty from "./PlasmicNewPage145.module.css"; // plasmic-import: S5bWOEkWn0/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicNewPage145.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicNewPage145.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
