...
import * as sty from "./PlasmicNewPage847.module.css"; // plasmic-import: vpf4FrZTmW/css
...
export interface DefaultNewPage847Props {
  dataFetches: PlasmicNewPage847__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"499415"}</title>
        <meta key="og:title" property="og:title" content={"499415"} />
      </Head>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <p.PlasmicImg
            ...
            src={{
              src: "/plasmic/wanga/images/_499415Page001Jpg.jpeg",
              fullWidth: 2480,
              fullHeight: 3508,
