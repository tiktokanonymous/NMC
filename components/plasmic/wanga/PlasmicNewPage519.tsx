...
import * as sty from "./PlasmicNewPage519.module.css"; // plasmic-import: FDceTisgZf/css
...
export interface DefaultNewPage519Props {
  dataFetches: PlasmicNewPage519__Fetches;
}
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{"500154"}</title>
        <meta key="og:title" property="og:title" content={"500154"} />
      </Head>
